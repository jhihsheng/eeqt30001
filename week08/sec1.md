...
Here $r,t$ are reflection and transmission amplitudes (not to be confused with the
squeeze parameter $r$ above). Energy conservation forces $U$ to be unitary:
$|r|^{2}+|t|^{2}=1$ and $tr^{*}+t'^{*}r'=0$. For a symmetric beam splitter the second condition fixes the
