...
3. Articulate the design thesis of nanophotonic quantum sensing: the generator $G$ is
   ...
   flow) and its open quantum structure-end and emitter-end problems.
```
...
arms, a length change of $\sim4\times10^{-18}$ m ($\approx1/400$ of a proton
diameter; the popular "1/10,000" figure refers to LIGO's best displacement
sensitivity, $\sim10^{-19}$ m). Today's lecture asks a single question about that feat: *who sets the
